...
import type { WorkflowUsageDetail } from '../types';
...
type SortField = keyof Omit<WorkflowRow, 'name'> | 'name';
...
const i18nPrefix = 'admin.workflowManagement.userTokenDashboard.modal';
      ...
      <div className="mt-4 rounded-lg border border-border bg-muted/30 p-4">
        ...
        <div className="grid grid-cols-2 gap-x-6 gap-y-1 text-sm">
          <span className="text-muted-foreground">
            {t(`${i18nPrefix}.summary.totalWorkflows`)}
          </span>
